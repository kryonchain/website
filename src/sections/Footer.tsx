    ...
    return (
        <footer className="py-12 px-4 border-t border-sky-500/20">
            <div className="max-w-6xl mx-auto text-center">
                <div className="text-3xl font-bold mb-4 bg-gradient-to-r text-white bg-clip-text text-transparent">
                    KRYON
                </div>
                ...
                <div className="flex justify-center gap-6 text-sm text-gray-500 mb-6">
                    <a href="mailto:info@kryonchain.com" className="hover:text-sky-400 transition-colors">Contact</a>
                </div>
